...
import {
  ...
  MessageSquare, Wifi, Activity, LogOut, Menu, X
} from 'lucide-react'
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            boxShadow: '0 0 20px var(--green-glow)', fontSize: 18
          }}>💬</div>
          <div>
        ...
        <div style={{ padding: '12px 10px', borderTop: '1px solid var(--border)' }}>
          <div style={{
            ...
            <button onClick={handleLogout}
              style={{ background: 'none', color: 'var(--text3)', padding: 4, borderRadius: 6, cursor: 'pointer' }}
              title="Sair">
              <LogOut size={14} />
            </button>
          </div>
      ...
      <div style={{ flex: 1, marginLeft: 240, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        <header className="mobile-header" style={{
          ...
          <button onClick={() => setOpen(true)}
            style={{ background: 'none', color: 'var(--text2)', cursor: 'pointer' }}>
            <Menu size={20} />
          </button>
